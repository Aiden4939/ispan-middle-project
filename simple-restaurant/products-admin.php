...
<script>
    ...
    container.addEventListener("click", function(e) {
        ...
        if (tar.classList.contains("add-type-btn")) {
            ...
            addBtn.innerHTML = '添加新類別';
            addBtn.setAttribute('type', 'button');
            addBtn.classList.add('add-type-btn');
            newType.appendChild(addBtn)
            // console.log(e.target.parentNode);
            // e.target.parentNode.insertBefore(newType, e.target.nextSibling);
            e.target.parentNode.parentNode.insertBefore(newType, e.target.parentNode.nextSibling);
        }
